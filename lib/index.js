...
const internals = {
    ...
    bigNumber: require('./types/bigNumber'),
...
internals.root = function () {
    ...
    root.bigNumber = function (...args) {

        Hoek.assert(args.length === 0, 'Joi.bigNumber() does not allow arguments.');

        return internals.callWithDefaults.call(this, internals.bigNumber, args);
    };
