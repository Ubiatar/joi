...
module.exports = internals.Any = class {
    ...
    _validate(value, state, options, reference, next) {
        ...
        Async.serie([
            (cb) => {
                ...
                if (this._coerce) {
                    ...
                    if (coerced.errors) {
                        ...
                        return cb(true);                            // Coerced error always aborts early
                    }
            ...
            (cb) => {
                ...
                if (this._flags.empty) {
                    this._flags.empty._validate(this._prepareEmptyValue(value), null, internals.defaults, null, ({ errors }) => {
            ...
            (cb) => {
                ...
                if (this._base) {
                    this._base.call(this, value, state, options, (base) => {

                        if (base.errors) {
                            value = base.value;
                            errors = errors.concat(base.errors);
                            return cb(true);                            // Base error always aborts early
                        }
            ...
            (cb) => {
                ...
                Async.for(this._tests, (test, i, nextTest) => {
                    ...
                    test.func.length === 3 ? testDone(test.func.call(this, value, state, options)) : test.func.call(this, value, state, options, testDone);
                }, cb);
            }
        ], () => {
    ...
    _validateWithOptions(value, options, callback) {
        ...
        const validation = (next = () => {}) => {
            ...
            if (result) {
                return next(errors, result.value);
            }
            this._validate(value, null, settings, null, (res) => {

                result = res;
                errors = Errors.process(res.errors, value);
                next(errors, res.value);
            });
        };
